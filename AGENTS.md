...
- `dotnet test tests/HyMT2Sharp.Tests -c Release`. Run it three ways when touching kernels:
  default (AVX2), `HYMT2SHARP_FORCE_PORTABLE=1` (Vector<T> tier, 256-bit), and
  `DOTNET_EnableAVX=0` (128-bit Vector<T>, same width as ARM64/NEON, no FMA).
